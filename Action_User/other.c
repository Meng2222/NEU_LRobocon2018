...
float Return_LinearRegressionEquation_k (uint16_t array[2][50], int num)
{
	
}
float Return_LinearRegressionEquation_b (uint16_t array[2][50], int num)
{
...
uint16_t APositionRecord[2][4]={{0},{0}};
uint16_t BPositionRecord[2][4]={{0},{0}};
uint16_t ATargetPositionRecord[2][50]={{0},{0}};
uint16_t BTargetPositionRecord[2][50]={{0},{0}};
...
//									/*解析数据*/
//									/*收数*/
//											USART_OUT(UART4,(uint8_t*)"%s%s%s","A","X",":");
//											GetFloat (ATargetPositionRecord[0][0], 3);
//											USART_OUT(UART4,(uint8_t*)"%s%s%s","A","Y",":");
//											GetFloat (ATargetPositionRecord[1][0], 3);
//								}
//								cntNum=0;
...
//判断剩余点范围
//	ATargetPositionRecord[0][0]=APositionRecord;
//	ATargetPositionRecord[1][0]=APositionRecord;
//	BTargetPositionRecord[0][0]=BPositionRecord;
//	BTargetPositionRecord[1][0]=BPositionRecord;
	
	//记录连续的15个
//	for(int ai=0 ; ai<=1 ; ai++)
//	{
//		for(int aj=14; aj>=1 ; aj--)
//		{
//			ATargetPositionRecord[ai][aj]=ATargetPositionRecord[ai][aj-1];
//		}
//	}
