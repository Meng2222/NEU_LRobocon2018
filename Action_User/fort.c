...
void GunneryData_Operation(GunneryData *Gun, PID_Value const *Pos)
{
	...
	Gun->ShooterVelSet = 0.0133f * Gun->Distance_Shoot + 35.267f + Gun->Shooter_Vel_Offset[Gun->BucketNum + Gun->Square_Mode * 4];
	Gun->No_Offset_ShooterVel = 0.0133f * Gun->Distance_Fort + 35.267f + Gun->Shooter_Vel_Offset[Gun->BucketNum + Gun->Square_Mode * 4];
