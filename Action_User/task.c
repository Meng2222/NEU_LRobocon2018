...
float I_value=0;//圆形
float KI=-0.12;//圆形
float rate=0.06;// 正方形  1m/s距离转化角度的比例为（0.06）,,1.5m/s为0.04,           0.15
   //正方形  提前量：duty=650(1m/s)，   1.5m/s duty为900，
float KP=0; //Kp给300(1m/s)，，，kp给450（1.5m/s）
float V0=0.5;//车的基础速度(m/s)
float buff=1500;//(最大偏离区域)
//////////////////////////////////////////////////////
//炮台参数
